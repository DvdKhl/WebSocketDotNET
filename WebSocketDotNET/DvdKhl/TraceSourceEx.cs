...
namespace DvdKhl {
	public class TraceSourceEx {
		...
		public TraceSourceEx(string name) : this(name, SourceLevels.Off) { }


		public IDisposable CreateActivity(string activityName) { return Base == null ? nopDisposable : CreateActivity(activityName, false, Guid.NewGuid()); }
		public IDisposable CreateActivity(string activityName, bool skipTransfer) { return Base == null ? nopDisposable : CreateActivity(activityName, skipTransfer, Guid.NewGuid()); }
